...
from .views import batches, finalize, health, migration_failure, migration_status
...
urlpatterns = [
    ...
    path("api/v1/migrations/<str:migration_id>/failure", migration_failure, name="migration-failure"),
